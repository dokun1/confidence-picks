<script>
  ...
  import { signInWithApple } from '../lib/authStore.js';
    ...
    if (errorParam) {
      switch (errorParam) {
        ...
        case 'apple_not_configured':
          error = 'Apple Sign In is not yet configured. Please use Google Sign In for now.';
          break;
        case 'apple_callback_failed':
          error = 'Apple authentication failed. Please try again or use Google Sign In.';
          break;
        default:
